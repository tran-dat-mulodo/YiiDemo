...
class PostController extends Controller {
	...
	public function filters() {
		return array('accessControl', // perform access control for CRUD operations
					// Test Page cache
					array('COutputCache + Index', 'duration'=>10,'varyByParam'=>array('id')),
		);
	}
	...
	public function accessRules() {
		return array( array('allow', // allow all users to access 'index' and 'view' actions.
			'actions' => array('index', 'view'), 'users' => array('*'), ), array('allow', // allow authenticated users to access all actions
	...
	public function actionTestCache() {
		$cache = Yii::app() -> cache;
		$time = $cache -> get('test_cache_nomal');
		//get cache
		if ($time === false) {//if cache is gone.
			$cache -> set('test_cache_nomal', time(), 30);
			//set cache
			$time = $cache -> get('test_cache_nomal');
		}
	 ...
	 */
	public function testDinamicContent() {
		return 'Test Dinamic Content: '.date("d-m-Y H:i:s", time());
	}
